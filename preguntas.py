...
p3 = Pregunta(1,"Considerando 02-11-2013 ¿Qué usarías para regresar la fecha?" ,"02-11-2013","Recuerda usar '\' para especificar caracteres")
p4 = Pregunta(2,"Haz match con '#insta<3U'","#insta<3U","Considera todos los caracteres especiales")
p5 = Pregunta(1,"Expresión que utilizarías para obtener un string con los primeros 10 caracteres de la CURP","SDGH980427","Recuerda que se compone de 4 letras y 6 números!")
